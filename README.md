...
api/                     fonctions serverless (une route = un fichier)
  ...
  groups/[groupId]/
    ...
    shop.js                 GET catalogue · POST ajouter un article (+ photo optionnelle)
    shop/[itemId].js         PATCH modifier/activer · DELETE (admin)
    shop/[itemId]/image.js    POST changer la photo · DELETE la retirer
    shop/seed-defaults.js     POST charger le pack d'articles par défaut
