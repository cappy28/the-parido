...
import { uploadAvatar, deleteAvatar } from '../../lib/avatarUpload.js';
...
export default requireAuth(async function handler(req, res) {
  ...
  try {
    const avatarUrl = await uploadAvatar({ userId: req.userId, dataUrl: imageBase64, previousUrl: current?.avatarUrl });
